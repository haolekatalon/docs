...
Image locator allows you to identify a test object with an image and perform web image-based testing. [Learn more](https://docs.katalon.com/katalon-studio/docs/web-image-based-testing.html)
